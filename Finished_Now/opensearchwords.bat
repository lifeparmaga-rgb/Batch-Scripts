...
@echo off
chcp 65001 >nul
title Professional File Manager
...
echo.
echo  ============================================================
echo                    Professional File Manager
echo  ============================================================
echo.
...
set /p choice= Choose Number OR Command:  
...
set /p keyword= Write File Name OR Part Of File:  
...
set /p openchoice= Choose File Number To Open It:  
